...
export class RsaService {
  ...
  constructor() {
    this.privateKey = this.privateKey?this.privateKey:fs.readFileSync(path.join(__dirname,'pkcs8.key'),'utf-8').toString();
    this.publicKey = this.publicKey?this.publicKey:fs.readFileSync(path.join(__dirname,'publickey.crt'),'utf-8').toString();
    this.enabled = true;
  }
...
var r =new RsaService();
let e = r.encrypt('secret');
console.log(r.decrypt(e));
